...
CREATE TABLE `user_conference` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_USER_CONF_CONF01_idx` (`conference_id`),
  KEY `FK_USER_CONF_USER01_idx` (`user_id`),
  CONSTRAINT `FK_USER_CONF_CONF01` FOREIGN KEY (`conference_id`) REFERENCES `conference` (`id`),
  CONSTRAINT `FK_USER_CONF_USER01` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2022-02-18 11:55:34

    ...
    <v-row>
      ...
      <v-col cols="8" style="margin-left: 2rem">
        ...
        <v-card class="primary">
          <span><strong>한마디</strong></span>
          <p v-if="user.profileDescription.length > 0">{{ user.profileDescription }}</p>
          <p v-else>아직 한마디가 없어요..</p>
        </v-card>
        <span>{{ conferences.length }}개의 책을 읽었어요!!</span>
      </v-col>
    </v-row>
